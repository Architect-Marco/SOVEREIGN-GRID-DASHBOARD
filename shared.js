        ...
        const DAW_ROW_H = 76; // was 56 — too short for its own content (10px padding + ~20px row1 + 8px gap + ~22px row2 + 10px padding ≈ 70px), which let the next track's row silently overlap and eat clicks on the upload icon underneath it
